...
print(NAMES_LIST)
nn_model = load_model('final_face_model2.h5',compile=False)
facenet = FaceNet()
...
class CameraApp:
    ...
    #To get list of indexes of all the available camera ports
    ...
    def show_camera_feed(self):
        if self.is_camera_active:
            ...
            if ret:
                ...
                if self.PoseDetect:
                    pass #call to pose detection function        
    ...
    def Recognise(self,input_frame):
        faces = detector.detect_faces(input_frame)
        for face in faces:
            x,y,w,h=face['box']
            img=input_frame[y:y+h, x:x+w]
